...
const handleJaiminiAstrology = async(message, user) => {
  if (
    !message.includes('jaimini') &&
    !message.includes('sphuta') &&
    !message.includes('karaka') &&
    !message.includes('jaimini astrology')
  ) {
    return null;
  }
  ...
  try {
    ...
    const karakaAnalysis = {
      introduction:
        'Jaimini sutras present an alternate approach to Vedic astrology, emphasizing karakas (significators) over traditional planetary rulerships.',
      karakas: [
        {
          name: 'Atmakaraka (Soul)',
          planet: 'Jupiter',
          significator: 'Spiritual development',
          description: 'Soul purpose and highest spiritual attainment'
        },
        {
          name: 'Amatyakaraka (Career)',
          planet: 'Mercury',
          significator: 'Professional success',
          description: 'Career and vocation fulfillment'
        },
        {
          name: 'Bhratru Karaka (Siblings)',
          planet: 'Saturn',
          significator: 'Family connections',
          description: 'Relationships with siblings and extended family'
        },
        {
          name: 'Matru Karaka (Mother)',
          planet: 'Venus',
          significator: 'Nurturing relationships',
          description: 'Mother-child relationships and emotional security'
        },
        {
          name: 'Putra Karaka (Children)',
          planet: 'Jupiter',
          significator: 'Legacy creation',
          description: 'Children, creativity, and future generations'
        }
      ],
      ...
      sphutaAnalysis: [
        {
          position: 'Ascendant significance',
          interpretation:
            'Sphuta calculation shows modified personality expression'
        },
        {
          position: 'Moon positioning',
          interpretation: 'Emotional development shows spiritual focus areas'
        }
      ],
      insights: [
        {
          insight:
            'Jaimini system emphasizes chart progression differently than Parashari'
        },
        {
          insight:
            'Karakas show specific life roles and karmic responsibilities'
        }
      ],
      guidance:
        'Jaimini astrology reveals the soul\'s particular journey through earthly experiences. Full implementation coming soon!'
    };
