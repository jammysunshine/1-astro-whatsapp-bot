  ...
  initializeHexagrams() {
    return {
      ...
      8: {
        ...
        lower: 5,
        judgment:
          'Holding Together brings good fortune. Inquire of the oracle once more whether you possess sublimity, constancy, and perseverance.',
        image:
      ...
      20: {
        ...
        image:
          'The wind blows over the earth: The image of Contemplation. Thus the kings of old visited the regions of the world.'
      },
      21: {
        name: 'Biting Through',
        upper: 2,
      ...
      22: {
        ...
        image:
          'Fire at the foot of the mountain: The image of Grace. Thus the superior man proceeds when the time has come.'
      },
      23: {
      ...
      24: {
        ...
        image:
          'Thunder within the earth: The image of Return. Thus the kings of antiquity closed the passes at the time of solstice.'
      },
      25: {
        name: 'Innocence',
        upper: 0,
        ...
        image:
          'Under heaven thunder rolls: The image of Innocence. Thus the kings of antiquity made music in order to honor merit.'
      },
      26: {
        ...
        image:
          'Heaven within the mountain: The image of The Taming Power of the Great. Thus the superior man acquaints himself with many sayings of antiquity.'
      },
      27: {
        ...
        image:
          'At the foot of the mountain, the lake: The image of Providing Nourishment. Thus the superior man is careful of his words and temperate in eating and drinking.'
      },
      28: {
        ...
        image:
          'The lake rises above the trees: The image of Preponderance of the Great. Thus the superior man, when he stands alone, is unconcerned.'
      },
      29: {
        name: 'The Abysmal',
        upper: 5,
        ...
        image:
          'Water flows on uninterruptedly and reaches its goal: The image of the Abysmal. Thus the superior man walks in lasting virtue.'
      },
      30: {
        name: 'The Clinging',
        upper: 2,
        ...
        image:
          'That which is bright rises twice: The image of The Clinging. Thus the great man, by perpetuating this brightness, illumines the four quarters of the world.'
      },
      31: {
        name: 'Influence',
        upper: 7,
      ...
      36: {
        ...
        image:
          'The light has sunk into the earth: The image of Darkening of the Light. Thus does the superior man live with the great mass.'
      },
      37: {
        name: 'The Family',
        upper: 4,
      ...
      42: {
        ...
        image:
          'Wind and thunder: The image of Increase. Thus the superior man, when he sees good, imitates it; when he has faults, he amends them.'
      },
      43: {
        name: 'Breakthrough',
        upper: 7,
        lower: 3,
        judgment:
          'Breakthrough. One must resolutely make the matter known at the court of the king. It must be announced truthfully.',
        image:
          'The lake has risen up to heaven: The image of Breakthrough. Thus the superior man bestows wealth downward and refrains from resting on his virtue.'
      },
      44: {
        name: 'Coming to Meet',
        upper: 0,
        ...
        image:
          'Under heaven, wind: The image of Coming to Meet. Thus does the prince act when disseminating his commands.'
      },
      45: {
      ...
      47: {
        ...
        image:
          'There is no water in the lake: The image of Oppression. Thus the superior man walks in lasting virtue and carries on the business of teaching.'
      },
      48: {
        name: 'The Well',
        upper: 5,
      ...
      50: {
        ...
        image:
          'Fire over wood: The image of The Cauldron. Thus the superior man, in accordance with the time, prepares the means of nourishment.'
      },
      51: {
        name: 'The Arousing',
        upper: 3,
        lower: 3,
        judgment:
          'The Arousing has success. One must be strong. One goes and comes and is without error.',
        image:
          'Thunder repeated: The image of The Arousing. Thus in his conduct the superior man gives preponderance to reverence.'
      },
      52: {
        name: 'Keeping Still',
        upper: 6,
        lower: 6,
        judgment:
          'Keeping Still. Keeping his back still so that he no longer feels his body. He goes into his courtyard and does not see his people.',
        image:
      ...
      53: {
        ...
        image:
          'On the mountain, a tree: The image of Development. Thus the superior man abides in dignity and virtue.'
      },
      54: {
      ...
      57: {
        ...
        image:
          'Winds following one upon the other: The image of The Gentle. Thus the superior man spreads his commands abroad.'
      },
      58: {
        name: 'The Joyous',
        upper: 4,
      ...
      61: {
        ...
        image:
          'Wind over lake: The image of Inner Truth. Thus the kings of old sacrificed to the Lord and built temples.'
      },
      62: {
      ...
      64: {
        ...
        image:
          'Fire over water: The image of Before Completion. Thus the superior man carefully discriminates among the qualities of things.'
      }
    };
  }
  ...
  healthCheck() {
    try {
      ...
      return {
        ...
        version: '1.0.0',
        status:
          trigramCount === 8 && hexagramCount === 64 ?
            'Complete' :
            'Incomplete'
      };
    } catch (error) {
