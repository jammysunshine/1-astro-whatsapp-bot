  ...
  constructor() {
    ...
    this.hexagrams = {
      ...
      51: {
        ...
        image:
          'Thunder repeated: The image of The Arousing. Thus in fear and trembling the superior man sets his life in order.',
      },
      52: {
        name: 'Keeping Still',
        upper: 6,
    ...
    try {
      ...
      const transformedHexagram =
        changingLines.length > 0
          ? this.transformHexagram(primaryHexagram, changingLines)
          : null;
