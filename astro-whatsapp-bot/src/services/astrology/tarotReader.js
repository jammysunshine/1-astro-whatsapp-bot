...
class TarotReader {
  constructor() {
    ...
    this.majorArcana = [
      ...
      },
      {
        ...
        number: 2,
        upright: 'Intuition, spiritual insight, divine feminine',
        reversed: 'Disconnection from intuition, withdrawal, silence'
      },
      {
        name: 'The Empress',
        number: 3,
        upright: 'Femininity, beauty, nature, abundance',
        reversed: 'Dependence on others, smothering, stagnation'
      },
      {
        name: 'The Emperor',
        number: 4,
        upright: 'Authority, establishment, structure, control',
        reversed: 'Tyranny, rigidity, coldness, control freak'
      },
      {
        name: 'The Hierophant',
        number: 5,
      ...
      },
      {
        ...
        reversed: 'Seeking personal closure, short-cut to success, impatience'
      }
    ];
    ...
    this.wands = [
      {
        ...
        reversed: 'Lack of energy, lack of passion, missed opportunities'
      },
      {
        name: 'Two of Wands',
      ...
      },
      {
        ...
        reversed: 'Obstacles, delays, lack of foresight, missed opportunities'
      },
      {
        name: 'Four of Wands',
      ...
      },
      {
        ...
        reversed:
          'Private achievement, personal success, pride, lack of recognition'
      },
      {
        name: 'Seven of Wands',
        upright: 'Challenge, competition, perseverance, defense',
        reversed: 'Exhaustion, giving up, overwhelmed, overly defensive'
      },
      {
        name: 'Eight of Wands',
        upright: 'Speed, action, alignment, air travel',
      ...
      },
      {
        name: 'Page of Wands',
        upright: 'Inspiration, ideas, discovery, limitless potential',
        reversed: 'Lack of direction, no clear plan, bad advice, distraction'
      },
      {
    ...
    this.cups = [
      {
        ...
        reversed: 'Self-love, intuition, repressed emotions, spirituality'
      },
      {
        name: 'Two of Cups',
      ...
      },
      {
        ...
        reversed:
          'Independence, alone time, hardcore partying, knowing yourself'
      },
      {
        name: 'Four of Cups',
        upright: 'Meditation, contemplation, apathy, reevaluation',
        reversed: 'Retreat, withdrawal, checking in with yourself, inner peace'
      },
      {
        name: 'Five of Cups',
        upright: 'Regret, failure, disappointment, pessimism',
        reversed: 'Personal setbacks, self-forgiveness, moving on, regret'
      },
      {
        name: 'Six of Cups',
        upright: 'Revisiting the past, childhood memories, innocence, joy',
        reversed:
          'Living in the past, forgiveness, lacking playfulness, lacking spontaneity'
      },
      {
        name: 'Seven of Cups',
        upright: 'Opportunities, choices, wishful thinking, illusion',
        reversed:
          'Alignment, personal values, overwhelmed by choices, indecision'
      },
      {
        name: 'Eight of Cups',
      ...
      },
      {
        ...
        reversed:
          'Disconnection, misaligned values, struggling relationships, disconnection'
      },
      {
        name: 'Page of Cups',
        upright:
      ...
      },
      {
        name: 'Knight of Cups',
        upright:
          'Creativity, romance, bringing or receiving a message, imagination',
        reversed:
          'Moodiness, disappointment, overactive imagination, lack of direction'
      },
      {
        name: 'Queen of Cups',
        upright:
        ...
        reversed:
          'Inner feelings, self-care, self-love, melancholy, emotionally needy'
      },
      {
        name: 'King of Cups',
        upright:
          'Emotionally balanced, compassionate, diplomatic, friendly, intuitive',
        reversed:
    ...
    this.swords = [
      {
        ...
        reversed:
          'Inner clarity, re-thinking an idea, clouded judgement, overconfidence'
      },
      {
        name: 'Two of Swords',
        upright:
      ...
      },
      {
        ...
        reversed:
          'Inner conflict, conflict avoidance, releasing tension, making amends'
      },
      {
        name: 'Six of Swords',
        upright: 'Transition, change, rite of passage, releasing baggage',
        reversed:
          'Personal transition, resistance to change, unfinished business, lack of progress'
      },
      {
        ...
        reversed:
          'Imposter syndrome, self-deception, keeping secrets, mental challenges'
      },
      {
      ...
      },
      {
        ...
        reversed:
          'Inner turmoil, deep-seated fears, shame, guilt, releasing worry'
      },
      {
        name: 'Ten of Swords',
        upright: 'Painful endings, deep wounds, betrayal, loss, crisis',
        reversed:
          'Recovery, regeneration, resisting an inevitable end, facing the truth'
      },
      {
        name: 'Page of Swords',
        upright:
      ...
      },
      {
        ...
        reversed:
          'Restless, unfocused, impulsive, burnt out, lack of direction'
      },
      {
        ...
        reversed:
          'Overly-emotional, easily influenced, bitchy, cold-hearted, righteous'
      },
      {
        name: 'King of Swords',
        upright:
          'Mental clarity, intellectual power, authority, truth, rational',
        reversed:
          'Quiet power, inner truth, misuse of power, manipulation, overactive mind'
      }
    ];
    ...
    this.pentacles = [
      {
        ...
        reversed: 'Lost opportunity, missed chance, bad investment, bad luck'
      },
      {
        name: 'Two of Pentacles',
        upright:
          'Multiple priorities, time management, prioritisation, organisation',
        reversed:
          'Over-committed, disorganisation, reprioritisation, overbooked'
      },
      {
        name: 'Three of Pentacles',
        upright: 'Collaboration, learning, implementation, teamwork, planning',
        reversed: 'Disharmony, misalignment, working alone, ego clashes'
      },
      {
        name: 'Four of Pentacles',
        upright: 'Saving money, security, conservatism, scarcity, control',
        reversed:
          'Over-spending, greed, self-protection, stinginess, possessiveness'
      },
      {
        name: 'Five of Pentacles',
        upright: 'Financial loss, poverty, lack mindset, isolation, worry',
        reversed:
          'Recovery from financial loss, spiritual poverty, lack mindset, isolation'
      },
      {
        name: 'Six of Pentacles',
        upright: 'Giving, receiving, sharing wealth, generosity, charity',
        reversed:
          'Self-care, unpaid debts, one-sided charity, selfishness, lack of motivation'
      },
      {
        ...
        reversed:
          'Lack of long-term vision, limited success or reward, impatience, lack of effort'
      },
      {
        name: 'Eight of Pentacles',
        upright: 'Apprenticeship, repetitive tasks, mastery, skill development',
        reversed:
          'Self-development, perfectionism, misdirected activity, boredom'
      },
      {
        name: 'Nine of Pentacles',
        upright: 'Abundance, luxury, self-sufficiency, financial independence',
        reversed:
          'Self-worth, over-investment in work, hustling, materialistic'
      },
      {
        ...
        reversed:
          'The dark side of wealth, financial failure or loss, lack of stability'
      },
      {
        name: 'Page of Pentacles',
        upright: 'Learning, studying, apprenticeship, new ideas, curiosity',
        reversed:
          'Lack of progress, procrastination, learn from failure, creative blocks'
      },
      {
        name: 'Knight of Pentacles',
        upright: 'Hard work, productivity, routine, conservatism, methodical',
        reversed:
          'Self-discipline, boredom, feeling stuck, perfectionism, misdirected activity'
      },
      {
        name: 'Queen of Pentacles',
        upright:
          'Nurturing, practical, providing financially and emotionally, intuitive',
        reversed:
          'Financial independence, self-care, work-home conflict, self-worth'
      },
      {
        name: 'King of Pentacles',
        upright:
          'Financial success, business acumen, security, discipline, abundance',
        reversed:
          'Financially inept, obsessed with wealth and status, stubborn, narrow-minded'
      }
    ];
    ...
    this.spreads = {
      ...
      three: {
        ...
        description:
          'Classic three-card spread showing past influences, current situation, and future potential'
      },
      celtic_cross: {
        name: 'Celtic Cross',
        positions: [
        ...
        description:
          'Comprehensive 10-card Celtic Cross spread for detailed life analysis'
      },
      relationship: {
  ...
  generateReadingSummary(cards, spreadType, question) {
    try {
      ...
      if (majorArcanaCount > cards.length * 0.6) {
        summary +=
          'This reading shows significant life changes and spiritual growth. ';
      }

      if (reversedCount > cards.length * 0.5) {
        summary +=
          'There may be internal conflicts or blocked energies to address. ';
      }
      ...
      case 'three':
        summary +=
            'Your past experiences are shaping your present, leading toward the future shown in these cards.';
        break;
      case 'celtic_cross':
        summary +=
            'This comprehensive reading reveals the complex dynamics affecting your life path.';
        break;
      case 'relationship':
        summary +=
            'The cards show the dynamics between you and your partner, with insights for growth.';
        break;
      case 'career':
        summary +=
            'Your career path shows potential for growth and new opportunities.';
        break;
      }
  ...
  formatReadingForWhatsApp(reading) {
    try {
      ...
      message += `*Summary:*\n${reading.summary}\n\n`;
      message +=
        '⭐ *Remember:* Tarot provides guidance, not certainty. Trust your intuition! ✨';
