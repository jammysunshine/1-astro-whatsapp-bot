...
const getDailyHoroscope = sign => {
  ...
  const horoscopes = {
    Aries:
      'Today brings energy and enthusiasm. Take initiative in your projects.',
    Taurus:
      'Focus on stability and practicality. Good day for financial matters.',
    Gemini: 'Communication is key. Share your ideas with others.',
    Cancer:
      'Emotional connections are highlighted. Nurture your relationships.',
  ...
  return (
    horoscopes[sign] ||
    'The stars align for a positive day. Trust your instincts.'
  );
};
